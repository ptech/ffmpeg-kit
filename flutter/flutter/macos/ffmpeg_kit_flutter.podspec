Pod::Spec.new do |s|
  ...
  s.subspec 'ffmpeg_kit_macos_local' do |ss|
    ss.vendored_frameworks = "Frameworks/ffmpeg-kit-min-gpl-6.0-macos-xcframework/ffmpegkit.xcframework", "Frameworks/ffmpeg-kit-min-gpl-6.0-macos-xcframework/libavcodec.xcframework", "Frameworks/ffmpeg-kit-min-gpl-6.0-macos-xcframework/libavdevice.xcframework", "Frameworks/ffmpeg-kit-min-gpl-6.0-macos-xcframework/libavfilter.xcframework", "Frameworks/ffmpeg-kit-min-gpl-6.0-macos-xcframework/libavformat.xcframework", "Frameworks/ffmpeg-kit-min-gpl-6.0-macos-xcframework/libavutil.xcframework", "Frameworks/ffmpeg-kit-min-gpl-6.0-macos-xcframework/libswresample.xcframework", "Frameworks/ffmpeg-kit-min-gpl-6.0-macos-xcframework/libswscale.xcframework"
  end
